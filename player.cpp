...
void player::release()
{
	delete an.idle_front, an.idle_back, an.idle_right;			//노말 _ 보통 애니
	delete an.walk_front, an.walk_back, an.walk_right;			//노말 / 배틀 _ 걷기 애니
	delete an.run_front, an.run_back, an.run_right;				//노말 _ 달리기 애니
	delete an.Bready_front, an.Bready_back, an.Bready_left;		//배틀 _ 준비 애니
	delete an.SB_front, an.SB_back, an.SB_left;					//배틀 _ 스탠바이 애니
	delete an.rush_front, an.rush_back, an.rush_right;			//배틀 _ 달려들기 애니
	delete an.atk_front, an.atk_back, an.atk_right;				//배틀 _ 공격 애니
	delete an.cri_front, an.cri_back, an.cri_right;				//배틀 _ 크리티컬 애니
	delete an.spin;												//배틀 _ 스핀 애니
	delete an.hit_front, an.hit_back, an.hit_right;				//배틀 _ 피격
	delete an.hit2_front, an.hit2_right;						//배틀 _ 피격2
	delete an.downs_front, an.downs_back, an.downs_right;		//배틀 _ 쓰러지기 직전
	delete an.down;												//배틀 _ 쓰러짐
	delete an.win;												//노말 _ 승리포즈
	delete an.Bwin_front, an.Bwin_back, an.Bwin_left;			//배틀 _ 승리
	delete an.cantRun_front, an.cantRun_back, an.cantRun_right;	//노말 _ 못달린다
	delete an.drink;											//노말 _ 마시기
	delete an.handsUp_front, an.handsUp_back;					//노말 _ 손들기	
	delete an.ladder;											//노말 _ 사다리	
	delete an.tied_front, an.tied_back, an.tied_right;			//노말 _ 묶임	
	delete an.what_front, an.what_back, an.what_right;			//노말 _ ?
}
